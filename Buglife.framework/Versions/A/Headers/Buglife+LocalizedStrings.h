...
LIFEStringKey LIFEStringKey_ReportABug = @"Report a Bug";
...
LIFEStringKey LIFEStringKey_Report = @"Report";
...
LIFEStringKey LIFEStringKey_SummaryInputFieldTitle = @"What happened?";
LIFEStringKey LIFEStringKey_SummaryInputFieldPlaceholder = @"Provide a summary of your report.";
LIFEStringKey LIFEStringKey_SummaryInputFieldAccessibilityHint = @"Text entered here is submitted with the bug report.";
...
LIFEStringKey LIFEStringKey_DiscardReportAlertTitle = @"Discard this report?";
LIFEStringKey LIFEStringKey_DiscardReportAlertMessage = @"All data for this report will be discarded... But you can always report another bug!";
