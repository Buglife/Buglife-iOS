...
typedef void (^LIFEImageEditorSegmentedControlDidChange)(LIFEToolButtonType);
...
@property (nonatomic, copy) LIFEImageEditorSegmentedControlDidChange didChangeHandler;
