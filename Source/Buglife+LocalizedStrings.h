...
LIFEStringKey LIFEStringKey_FileAnytime = @"You can send feedback at any time by";
LIFEStringKey LIFEStringKey_ShakingTheDevice = @"shaking the device";
LIFEStringKey LIFEStringKey_TakingAScreenshot = @"taking a screenshot";
LIFEStringKey LIFEStringKey_TappingTheFloatingBugButton = @"tapping the floating bug button";
LIFEStringKey LIFEStringKey_RecordingTheScreen = @"recording the screen";
LIFEStringKey LIFEStringKey_ListItemDivider = @", ";
LIFEStringKey LIFEStringKey_Or = @"or";
LIFEStringKey LIFEStringKey_SentenceTerminator = @".";
