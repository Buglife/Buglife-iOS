...
@interface LIFEUserDefaults : NSObject
...
// Email address that was last submited via the userEmail text field
@property (nonatomic) NSString *lastSubmittedUserEmailFieldValue;
